...
fn main() {
    ...
    let mut u1 = Vector::from([2.0, 3.0]);
    let v1 = Vector::from([5.0, 7.0]);
    println!("u = {}\nv = {}", &u1, &v1);
    u1.add(v1);
    println!("u + v = {}", &u1);
    ...
    let mut u2 = Vector::from([2.0, 3.0]);
    let v2 = Vector::from([5.0, 7.0]);
    println!("u = {}\nv = {}", &u2, &v2);
    u2.sub(v2);
    println!("u - v = {}", &u2);
    ...
    let mut u3 = Vector::from([2.0, 3.0]);
    let scalar = 2.0;
    println!("u = {}\ns = {}", &u3, scalar);
    u3.scl(scalar);
    println!("u * s = {}", &u3);
    ...
    println!("Testing subtraction:");
    let mut m3 = Matrix::from([[1.0, 2.0], [3.0, 4.0]]);
    let m4 = Matrix::from([[7.0, 4.0], [-2.0, 2.0]]);
    println!("m1 = \n{}\nm2 = \n{}", &m3, &m4);
    m3.sub(m4);
    println!("m1 - m2 = \n{}", &m3);
    ...
    println!("Testing scalar multiplication:");
    let mut m5 = Matrix::from([[1.0, 2.0], [3.0, 4.0]]);
    let scalar = 2.0;
    println!("m = \n{}\ns = {}", &m5, scalar);
    m5.scl(scalar);
    println!("m * s = \n{}", &m5);
